...
public enum CompoundWordEnding {
    ...
    HARU_SAMAKSHA_1("हरूसमक्ष"),
    HARU_SAMAKSHA_2("हरुसमक्ष"),
    HARUSITA_1("हरुसित"),
    HARUSITA_2("हरूसित"),
    HARUSITAI_1("हरुसितै"),
    HARUSITAI_2("हरूसितै"),
    ...
    KO_LAGI("कोलागी"),
    LAEE("लार्इ"),
    LAEE_2("लाई"), //TODO: These characters might be different. Analyze LAEE and LAEE_2
    LAGAYAT("लगायत"),
    LAGAYAT_SANGA("लगायतसँग"),
    LAGAYAT_LE("लगायतले"),
    LAGAYATKA("लगायतका"),
    LAGAYATKO("लगायतको"),
    LAGAYATMA("लगायतमा"),
